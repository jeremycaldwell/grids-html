...
gs = {
			...
			if(e.metaKey || e.ctrlKey) {
				...
				switch (e.which || e.keyCode) {
					case 71:
						...
						if (!gw) gs.show(['s','m','l'], [6,6,12], [480,768,1200]);
	...
	show: function (p, c, w) {
		...
		var b = document.getElementsByTagName('body')[0],
			gw = '<div id="gridwrap"><div id="gridoverlay" class="page">',
...
if (window.location.href.match('gridset=show')) gs.show(['s','m','l'], [6,6,12], [480,768,1200]);
else gs.init(['s','m','l'], [6,6,12], [480,768,1200]);